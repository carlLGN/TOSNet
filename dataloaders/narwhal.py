...
class NARWHAL(data.Dataset):
    def __init__(
        self,
        split='test',
        root=Path.db_root_dir('narwhal'),
        transform=None,
        area_thres=0,
        retname=True):
        ...
        if (not self._check_preprocess()):
            print('Preprocessing NARWHAL dataset, this will take long, but it '
...
if __name__ == '__main__':
    ...
    dataset = NARWHAL(transform=transform)
