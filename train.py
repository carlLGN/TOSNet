...
import dataloaders.narwhal_train as narwhal_train
...
NUM_THIN_SAMPLES = 1            # number of samples consisting of thin parts
...
ROI_SIZE = 128                  # patch size for training
...
# weights and biases
wandb.login(key = '944c446506b6d10e38630700d49f34a98ff4bc70',
            verify = True
)
...
if __name__ == '__main__':
    ...
    elif len(args.dataset) == 1 and args.dataset[0] == 'narwhal_train':
        db_train = narwhal_train.NarwhalTrain(split='train', 
                        transform=composed_transforms_tr, use_thin=True)
    ...
    for epoch in range(args.num_epochs):
        ...
        # Wandb write loss
        mean_loss = total_loss/num_img_tr
        wandb.log({"Mean Epoch Loss": mean_loss})
        # Save the model
