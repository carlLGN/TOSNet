...
import dataloaders.narwhal as narwhal
...
def parse_args():
    ...
    parser.add_argument('--test_set', type=str, default='narwhal')
    parser.add_argument('--result_dir', type=str, default=None)
    parser.add_argument('--cfg', type=str, default='weights/run_42/TOSNet.txt')
    parser.add_argument('--weights', type=str, default='weights/run_42/models/TOSNet_epoch-19.pth')
...
if __name__ == '__main__':
    ...
    elif args.test_set == 'narwhal':
        db = narwhal.NARWHAL(split='test', transform=composed_transforms_ts)
    else:
